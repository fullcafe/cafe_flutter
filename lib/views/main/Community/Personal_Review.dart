...
class PersonalReviewPage extends StatelessWidget {
  const PersonalReviewPage({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: GridView.builder(
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: 0.8, // 카드의 가로와 세로 비율 조정
          ),
          ...
          itemBuilder: (context, index) {
            ...
            return PersonalCard(
              ...
              text: photo['text']!,
              keyword1: photo['keyword1']!,
              keyword2: photo['keyword2']!,
            );
          },
        ),
      ),
